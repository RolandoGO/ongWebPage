...
export const ActivitiesScreen = () => {
    ...
    const activities = [
      {idActivity: 1, img: imgTest, name: 'Ayuda Comunitaria', createdAt: 'Mayo'},
      {idActivity: 2, img: imgTest, name: 'Comedor Infantil', createdAt: 'Abril'},
      {idActivity: 3, img: imgTest, name: 'Apoyo Escolar', createdAt: 'Julio'},
      {idActivity: 4, img: imgTest, name: 'Apoyo Escolar', createdAt: 'Julio'},
    ];

    const memoActivity = useMemo(()=> activities.map(activity => {
      return (<CardActivityScreen
